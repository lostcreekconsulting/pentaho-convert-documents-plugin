...
import org.pentaho.di.trans.step.StepMetaInterface;
import org.pentaho.di.ui.trans.steps.convertdocuments.ConvertDocumentsDialog;
import org.pentaho.metastore.api.IMetaStore;

import org.w3c.dom.Node;

public class ConvertDocumentsMeta extends BaseStepMeta implements StepMetaInterface {
    ...
    public ConvertDocumentsMeta() {
        super();
    }

    public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
        return new ConvertDocumentsDialog(shell, meta, transMeta, name);
    }

    public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta, Trans disp) {
        return new ConvertDocuments(stepMeta, stepDataInterface, cnr, transMeta, disp);
    }

    public StepDataInterface getStepData() {
        return new ConvertDocumentsData();
    }
    ...
    public Object clone() {
        return (ConvertDocumentsMeta) super.clone();
    }
    ...
    public void loadXML(Node stepNode, List<DatabaseMeta> databases, IMetaStore metaStore) throws KettleXMLException {
        try {
            ...
            throw new KettleXMLException(BaseMessages.getString(PKG, "ConvertDocumentsMeta.Exception.UnableToReadStepInfo"), e);
        }
    }
    ...
    public void readRep(Repository repo, IMetaStore metaStore, ObjectId stepId, List<DatabaseMeta> databases) throws KettleException {
        try {
            ...
            throw new KettleException(BaseMessages.getString(PKG, "ConvertDocumentsMeta.Exception.UnexpectedErrorReadingStepInfo"), e);
        }
    }
    ...
    public void saveRep(Repository rep, IMetaStore metaStore, ObjectId transformationId, ObjectId stepId) throws KettleException {
        try {
            ...
            throw new KettleException(BaseMessages.getString(PKG, "ConvertDocumentsMeta.Exception.UnableToSaveStepInfo") + stepId, e);
        }
    }
}
